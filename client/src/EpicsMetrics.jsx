...
class EpicsMetrics extends React.Component {
    ...
    render() {
      return(
        <div>
          <a href="https://sparefoot.atlassian.net/secure/RapidBoard.jspa?rapidView=270" target="_blank" rel="noopener noreferrer">Epics In Progress - Big Rocks vs. non-Big Rocks</a>
