...
export class StackedDualLineChart extends React.Component {
  componentDidMount() {
    this.drawChart()
  }
  ...
  drawChart() {    
    ...
    const lineBVals = this.props.lineB
    const lineB = this.props.lineB.map((d, i) => {
      return d + lineA[i]
    })
    ...
    svg.selectAll(".dot")
      ...
      .append("circle")
        ...
        .on("mousemove", function (d, i) {
          ...
          let yPosition = d3.mouse(this)[1] - 25
          tooltip.attr("transform", "translate(" + xPosition + "," + yPosition + ")")
          tooltip.select("text").text(lineBVals[i])
        })
